...
CATLOGO = "https://telegra.ph/file/c0cdf554e1587506a5b53.jpg"
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**Catuserbot"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/EITHON"),
                )
            ]
            ...
            result = builder.article(
                title="Jmthon Help™",
                description="**▾∮ قائمة التعليمات الخاصة بــ ايثون **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/EITHON"),
                Button.url(
                    "المطور",
                    "t.me/Mohmad990754",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل ايثون من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝐄𝐈𝐓𝐇𝐎𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 🧸♥](https://t.me/EITHON)",
