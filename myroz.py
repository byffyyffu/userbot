...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [
                    Button.url("• مطور السورس •", "https://t.me/Mohmad990754"),
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("• جروب السورس  •", "https://t.me/eithonsupport")],
            ],
        )
...
# Telegram  :  @Mohmad990754  - @Mohmad990754   -  
...
""" Telegram  :  @Mohmad990754  - @Mohmad990754   -  https://t.me/EITHON  """
"""  𝐄𝐈𝐓𝐇𝐎𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 """
