...
@EITHON.on(admin_cmd(pattern="وضع بايو (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@EITHON.on(admin_cmd(pattern="وضع اسم ((.|\n)*)"))
async def _(event):
    if event.fwd_from:
        return
...
@EITHON.on(admin_cmd(pattern="وضع صورة"))
async def _(event):
    if event.fwd_from:
        return
...
@EITHON.on(admin_cmd(pattern="حذف صورة ?(.*)"))
...
@EITHON.on(admin_cmd(pattern="انشائي$"))
async def _(event):
