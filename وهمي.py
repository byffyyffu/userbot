...
@EITHON.on(admin_cmd(pattern="2022"))
async def _(muhammad):
       await muhammad.edit(B)


@EITHON.on(admin_cmd(pattern="كتابة(?: |$)(.*)"))
async def _(event):
...
@EITHON.on(admin_cmd(pattern="صوتية(?: |$)(.*)"))
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@EITHON.on(admin_cmd(pattern="فيد(?: |$)(.*)"))
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@EITHON.on(admin_cmd(pattern="لعبة(?: |$)(.*)"))
async def _(event):
    t = event.pattern_match.group(1)
    if not (t or t.isdigit()):
        t = 100
...
@EITHON.on(admin_cmd(pattern="الرابط$"))
async def _(e):
...
@EITHON.on(admin_cmd(pattern="للكل تاك$"))
async def listall(EITHON):
    if EITHON.fwd_from:
        return
...
@EITHON.on(admin_cmd(pattern="نزوج(?:\s|$)([\s\S]*)"))
...
@EITHON.on(admin_cmd(pattern="طلاك(?:\s|$)([\s\S]*)"))
...
@EITHON.on(admin_cmd(pattern="طقس (.*)"))
@EITHON.on(sudo_cmd(pattern="طقس (.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
from EITHON.utils import admin_cmd
...
@EITHON.on(admin_cmd(pattern=r"سبونج"))
async def kerz(kerz):
    await kerz.edit(R)
...
@EITHON.on(admin_cmd(pattern=r"كلب"))
async def dog(dog):
    await dog.edit(A)
    Z = (
        "┈┏━╮╭━┓┈╭━━━━╮\n"
...
@EITHON.on(admin_cmd(pattern=r"ذئب"))
async def fox(fox):
    await fox.edit(A)


@EITHON.on(admin_cmd(pattern=r"فيل"))
async def elephant(elephant):
    await elephant.edit(A)


@EITHON.on(admin_cmd(pattern=r"هومر"))
async def homer(homer):
    await homer.edit(N)


@EITHON.on(admin_cmd(pattern=r"بك"))
async def pig(pig):
    await pig.edit(Z)
